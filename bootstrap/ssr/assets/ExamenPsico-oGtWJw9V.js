                                                              ...
                                                              default: withCtx((_10, _push11, _parent11, _scopeId10) => {
                                                                if (_push11) {
                                                                  _push11(ssrRenderComponent(_component_v_text_field, {
                                                                    modelValue: state.editedItem.tipo_vehiculo,
                                                                    "onUpdate:modelValue": ($event) => state.editedItem.tipo_vehiculo = $event,
                                                                    label: "Tipo de vehículo",
                                                                    type: "text",
                                                                    variant: "underlined"
                                                                  }, null, _parent11, _scopeId10));
                                                                  _push11(ssrRenderComponent(_component_v_text_field, {
                                                                    modelValue: state.editedItem.contraindicacion,
                                                                    "onUpdate:modelValue": ($event) => state.editedItem.contraindicacion = $event,
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Paciente/Componentes/Examenes/ExamenPsico.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const ExPsico = /* @__PURE__ */ _export_sfc(_sfc_main, [["__file", "/home/omar/www/esalud/resources/js/Pages/Paciente/Componentes/Examenes/ExamenPsico.vue"]]);
export {
  ExPsico as default
};
//# sourceMappingURL=ExamenPsico-oGtWJw9V.js.map
