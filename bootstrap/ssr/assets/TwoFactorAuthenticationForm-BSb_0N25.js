...
import { A as ActionSection } from "./Modal-C0i_bFQY.js";
import { D as DialogModal } from "./DialogModal-CWfZrpOs.js";
import { T as TextInput, I as InputError } from "./TextInput-AKTH8tze.js";
import { P as PrimaryButton } from "./PrimaryButton-5J5uN7b-.js";
import { S as SecondaryButton } from "./SecondaryButton-DX2LqBEU.js";
import { _ as _export_sfc } from "./_plugin-vue_export-helper-1tPrXgE0.js";
import { D as DangerButton } from "./DangerButton-1WlxjJMA.js";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(DialogModal, {
        ...
        footer: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(SecondaryButton, { onClick: closeModal }, {
            ...
            return [
              createVNode(SecondaryButton, { onClick: closeModal }, {
                default: withCtx(() => [
                  createTextVNode(" Cancel ")
                ]),
                _: 1
...
const ConfirmsPassword = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__file", "/home/blueshadows/www/app-empresas/resources/js/Components/ConfirmsPassword.vue"]]);
const _sfc_main = {
      ...
      _push(ssrRenderComponent(ActionSection, _attrs, {
        ...
        content: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (!twoFactorEnabled.value) {
              _push2(`<div${_scopeId}>`);
              _push2(ssrRenderComponent(ConfirmsPassword, { onConfirmed: enableTwoFactorAuthentication }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
              ...
              _push2(`<div${_scopeId}>`);
              _push2(ssrRenderComponent(ConfirmsPassword, { onConfirmed: confirmTwoFactorAuthentication }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    if (confirming.value) {
                      _push3(ssrRenderComponent(PrimaryButton, {
                    ...
                    return [
                      confirming.value ? (openBlock(), createBlock(PrimaryButton, {
                        key: 0,
                        type: "button",
                        class: ["me-3", { "opacity-25": enabling.value }],
                        disabled: enabling.value
              ...
              _push2(ssrRenderComponent(ConfirmsPassword, { onConfirmed: regenerateRecoveryCodes }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    if (recoveryCodes.value.length > 0 && !confirming.value) {
                      _push3(ssrRenderComponent(SecondaryButton, { class: "me-3" }, {
                        default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                          if (_push4) {
                    ...
                    return [
                      recoveryCodes.value.length > 0 && !confirming.value ? (openBlock(), createBlock(SecondaryButton, {
                        key: 0,
                        class: "me-3"
                      }, {
                        default: withCtx(() => [
              ...
              _push2(ssrRenderComponent(ConfirmsPassword, { onConfirmed: showRecoveryCodes }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    if (recoveryCodes.value.length === 0 && !confirming.value) {
                      _push3(ssrRenderComponent(SecondaryButton, { class: "me-3" }, {
              ...
              _push2(ssrRenderComponent(ConfirmsPassword, { onConfirmed: disableTwoFactorAuthentication }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    if (confirming.value) {
                    ...
                    return [
                      confirming.value ? (openBlock(), createBlock(SecondaryButton, {
                        key: 0,
                        class: { "opacity-25": disabling.value },
                        disabled: disabling.value
                      }, {
              ...
              _push2(ssrRenderComponent(ConfirmsPassword, { onConfirmed: disableTwoFactorAuthentication }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    ...
                    return [
                      !confirming.value ? (openBlock(), createBlock(DangerButton, {
                        key: 0,
                        class: { "opacity-25": disabling.value },
                        disabled: disabling.value
                      }, {
            ...
            return [
              ...
              createVNode("div", { class: "mt-5" }, [
                !twoFactorEnabled.value ? (openBlock(), createBlock("div", { key: 0 }, [
                  createVNode(ConfirmsPassword, { onConfirmed: enableTwoFactorAuthentication }, {
                    default: withCtx(() => [
                      createVNode(PrimaryButton, {
                        type: "button",
                        class: { "opacity-25": enabling.value },
                  ...
                  createVNode(ConfirmsPassword, { onConfirmed: confirmTwoFactorAuthentication }, {
                    default: withCtx(() => [
                      confirming.value ? (openBlock(), createBlock(PrimaryButton, {
                        key: 0,
                        type: "button",
                  ...
                  createVNode(ConfirmsPassword, { onConfirmed: regenerateRecoveryCodes }, {
                    default: withCtx(() => [
                      recoveryCodes.value.length > 0 && !confirming.value ? (openBlock(), createBlock(SecondaryButton, {
                        key: 0,
                        class: "me-3"
                  ...
                  createVNode(ConfirmsPassword, { onConfirmed: showRecoveryCodes }, {
                    default: withCtx(() => [
                      recoveryCodes.value.length === 0 && !confirming.value ? (openBlock(), createBlock(SecondaryButton, {
                        key: 0,
                        class: "me-3"
                  ...
                  createVNode(ConfirmsPassword, { onConfirmed: disableTwoFactorAuthentication }, {
                    default: withCtx(() => [
                      confirming.value ? (openBlock(), createBlock(SecondaryButton, {
                        key: 0,
                        class: { "opacity-25": disabling.value },
...
const TwoFactorAuthenticationForm = /* @__PURE__ */ _export_sfc(_sfc_main, [["__file", "/home/blueshadows/www/app-empresas/resources/js/Pages/Profile/Partials/TwoFactorAuthenticationForm.vue"]]);
export {
  TwoFactorAuthenticationForm as default
};
//# sourceMappingURL=TwoFactorAuthenticationForm-BSb_0N25.js.map
