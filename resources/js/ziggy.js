const Ziggy = {
    ...
    routes: {
        ...
        "vacuna.consulta": { uri: "consulta/vacuna", methods: ["GET", "HEAD"] },
        "licencia.search": {
        ...
        "diat.consulta": { uri: "consulta/diat", methods: ["GET", "HEAD"] },
        "diep.search": {
            uri: "consulta/diep/search",
            methods: ["GET", "HEAD"],
        },
        "diep.consulta": { uri: "consulta/diep", methods: ["GET", "HEAD"] },
        "exalcohol.consulta": {
        ...
        "exepo.consulta": { uri: "consulta/exepo", methods: ["GET", "HEAD"] },
        "expsico.consulta": {
        ...
        "alcohol.index": { uri: "examen/alcohol", methods: ["GET", "HEAD"] },
        "alcohol.create": {
            uri: "examen/alcohol/create",
            methods: ["GET", "HEAD"],
        },
        "alcohol.store": { uri: "examen/alcohol", methods: ["POST"] },
        "alcohol.show": {
        ...
        "aldehido.index": { uri: "examen/aldehido", methods: ["GET", "HEAD"] },
        "aldehido.create": {
            uri: "examen/aldehido/create",
            methods: ["GET", "HEAD"],
        },
        "aldehido.store": { uri: "examen/aldehido", methods: ["POST"] },
        "aldehido.show": {
        ...
        "asma.index": { uri: "examen/asma", methods: ["GET", "HEAD"] },
        "asma.create": { uri: "examen/asma/create", methods: ["GET", "HEAD"] },
        "asma.store": { uri: "examen/asma", methods: ["POST"] },
        "asma.show": {
            uri: "examen/asma/{asma}",
            methods: ["GET", "HEAD"],
            parameters: ["asma"],
        },
        "asma.edit": {
            uri: "examen/asma/{asma}/edit",
            methods: ["GET", "HEAD"],
            parameters: ["asma"],
        },
        "asma.update": {
        ...
        "epo.index": { uri: "examen/epo", methods: ["GET", "HEAD"] },
        "epo.create": { uri: "examen/epo/create", methods: ["GET", "HEAD"] },
        "epo.store": { uri: "examen/epo", methods: ["POST"] },
        "epo.show": {
            uri: "examen/epo/{epo}",
            methods: ["GET", "HEAD"],
            parameters: ["epo"],
        ...
        "equilibrio.store": { uri: "examen/equilibrio", methods: ["POST"] },
        "equilibrio.show": {
            uri: "examen/equilibrio/{equilibrio}",
            methods: ["GET", "HEAD"],
            parameters: ["equilibrio"],
        },
        "equilibrio.edit": {
        ...
        "humonegro.store": { uri: "examen/humonegro", methods: ["POST"] },
        "humonegro.show": {
            uri: "examen/humonegro/{humonegro}",
            methods: ["GET", "HEAD"],
            parameters: ["humonegro"],
        },
        "humonegro.edit": {
        ...
        "metal.index": { uri: "examen/metal", methods: ["GET", "HEAD"] },
        "metal.create": {
            uri: "examen/metal/create",
            methods: ["GET", "HEAD"],
        },
        "metal.store": { uri: "examen/metal", methods: ["POST"] },
        "metal.show": {
        ...
        "psico.index": { uri: "examen/psico", methods: ["GET", "HEAD"] },
        "psico.create": {
            uri: "examen/psico/create",
            methods: ["GET", "HEAD"],
        },
        "psico.store": { uri: "examen/psico", methods: ["POST"] },
        "psico.show": {
        ...
        "pvtmert.index": { uri: "examen/pvtmert", methods: ["GET", "HEAD"] },
        "pvtmert.create": {
            uri: "examen/pvtmert/create",
            methods: ["GET", "HEAD"],
        },
        "pvtmert.store": { uri: "examen/pvtmert", methods: ["POST"] },
        "pvtmert.show": {
        ...
        "respirador.store": { uri: "examen/respirador", methods: ["POST"] },
        "respirador.show": {
            uri: "examen/respirador/{respirador}",
            methods: ["GET", "HEAD"],
            parameters: ["respirador"],
        },
        "respirador.edit": {
        ...
        "ruido.index": { uri: "examen/ruido", methods: ["GET", "HEAD"] },
        "ruido.create": {
            uri: "examen/ruido/create",
            methods: ["GET", "HEAD"],
        },
        "ruido.store": { uri: "examen/ruido", methods: ["POST"] },
        "ruido.show": {
        ...
        "salud.index": { uri: "examen/salud", methods: ["GET", "HEAD"] },
        "salud.create": {
            uri: "examen/salud/create",
            methods: ["GET", "HEAD"],
        },
        "salud.store": { uri: "examen/salud", methods: ["POST"] },
        "salud.show": {
        ...
        "silice.index": { uri: "examen/silice", methods: ["GET", "HEAD"] },
        "silice.create": {
            uri: "examen/silice/create",
            methods: ["GET", "HEAD"],
        },
        "silice.store": { uri: "examen/silice", methods: ["POST"] },
        "silice.show": {
        ...
        "solvente.index": { uri: "examen/solvente", methods: ["GET", "HEAD"] },
        "solvente.create": {
            uri: "examen/solvente/create",
            methods: ["GET", "HEAD"],
        },
        "solvente.store": { uri: "examen/solvente", methods: ["POST"] },
        "solvente.show": {
        ...
        "somnolencia.store": { uri: "examen/somnolencia", methods: ["POST"] },
        "somnolencia.show": {
            uri: "examen/somnolencia/{somnolencium}",
            methods: ["GET", "HEAD"],
            parameters: ["somnolencium"],
        },
        "somnolencia.edit": {
        ...
        "accidente.store": { uri: "secundaria/accidente", methods: ["POST"] },
        "accidente.show": {
            uri: "secundaria/accidente/{accidente}",
            methods: ["GET", "HEAD"],
            parameters: ["accidente"],
        },
        "accidente.edit": {
        ...
        "accidente_condicion.show": {
            ...
            methods: ["GET", "HEAD"],
            parameters: ["accidente_condicion"],
        },
        ...
        "afp.index": { uri: "secundaria/afp", methods: ["GET", "HEAD"] },
        "afp.create": {
            uri: "secundaria/afp/create",
            methods: ["GET", "HEAD"],
        },
        "afp.store": { uri: "secundaria/afp", methods: ["POST"] },
        "afp.show": {
        ...
        "area.index": { uri: "secundaria/area", methods: ["GET", "HEAD"] },
        "area.create": {
            uri: "secundaria/area/create",
            methods: ["GET", "HEAD"],
        },
        "area.store": { uri: "secundaria/area", methods: ["POST"] },
        "area.show": {
        ...
        "bateria.store": { uri: "secundaria/bateria", methods: ["POST"] },
        "bateria.show": {
        ...
        "ceco.index": { uri: "secundaria/ceco", methods: ["GET", "HEAD"] },
        "ceco.create": {
            uri: "secundaria/ceco/create",
            methods: ["GET", "HEAD"],
        },
        "ceco.store": { uri: "secundaria/ceco", methods: ["POST"] },
        "ceco.show": {
        ...
        "cie10.index": { uri: "secundaria/cie10", methods: ["GET", "HEAD"] },
        "cie10.create": {
            uri: "secundaria/cie10/create",
            methods: ["GET", "HEAD"],
        },
        "cie10.store": { uri: "secundaria/cie10", methods: ["POST"] },
        "cie10.show": {
        ...
        "derivacion.store": { uri: "secundaria/derivacion", methods: ["POST"] },
        "derivacion.show": {
            uri: "secundaria/derivacion/{derivacion}",
            methods: ["GET", "HEAD"],
            parameters: ["derivacion"],
        },
        "derivacion.edit": {
        ...
        "empresa.store": { uri: "secundaria/empresa", methods: ["POST"] },
        "empresa.show": {
        ...
        "estado_certificacion.show": {
            ...
            methods: ["GET", "HEAD"],
            parameters: ["estado_certificacion"],
        },
        ...
        "estado_examen.index": {
            uri: "secundaria/estado_examen",
            methods: ["GET", "HEAD"],
        },
        "estado_examen.create": {
            uri: "secundaria/estado_examen/create",
            methods: ["GET", "HEAD"],
        },
        "estado_examen.store": {
            uri: "secundaria/estado_examen",
        ...
        "estado_examen.show": {
            uri: "secundaria/estado_examen/{estado_examan}",
            methods: ["GET", "HEAD"],
            parameters: ["estado_examan"],
        },
        "estado_examen.edit": {
            uri: "secundaria/estado_examen/{estado_examan}/edit",
            methods: ["GET", "HEAD"],
            parameters: ["estado_examan"],
        },
        "estado_examen.update": {
            uri: "secundaria/estado_examen/{estado_examan}",
            methods: ["PUT", "PATCH"],
            parameters: ["estado_examan"],
        },
        "estado_examen.destroy": {
            uri: "secundaria/estado_examen/{estado_examan}",
            methods: ["DELETE"],
            parameters: ["estado_examan"],
        },
        ...
        "estado_epo.store": { uri: "secundaria/estado_epo", methods: ["POST"] },
        "estado_epo.show": {
            uri: "secundaria/estado_epo/{estado_epo}",
            methods: ["GET", "HEAD"],
            parameters: ["estado_epo"],
        },
        "estado_epo.edit": {
        ...
        "exposicion.store": { uri: "secundaria/exposicion", methods: ["POST"] },
        "exposicion.show": {
            uri: "secundaria/exposicion/{exposicion}",
            methods: ["GET", "HEAD"],
            parameters: ["exposicion"],
        },
        "exposicion.edit": {
        ...
        "genero.index": { uri: "secundaria/genero", methods: ["GET", "HEAD"] },
        "genero.create": {
            uri: "secundaria/genero/create",
            methods: ["GET", "HEAD"],
        },
        "genero.store": { uri: "secundaria/genero", methods: ["POST"] },
        "genero.show": {
        ...
        "nivelInstruccion.index": {
            uri: "secundaria/nivelInstruccion",
            methods: ["GET", "HEAD"],
        },
        "nivelInstruccion.create": {
            uri: "secundaria/nivelInstruccion/create",
            methods: ["GET", "HEAD"],
        },
        "nivelInstruccion.store": {
            uri: "secundaria/nivelInstruccion",
            methods: ["POST"],
        },
        "nivelInstruccion.show": {
            uri: "secundaria/nivelInstruccion/{nivelInstruccion}",
            methods: ["GET", "HEAD"],
            parameters: ["nivelInstruccion"],
        },
        "nivelInstruccion.edit": {
            uri: "secundaria/nivelInstruccion/{nivelInstruccion}/edit",
            methods: ["GET", "HEAD"],
            parameters: ["nivelInstruccion"],
        },
        "nivelInstruccion.update": {
            uri: "secundaria/nivelInstruccion/{nivelInstruccion}",
            methods: ["PUT", "PATCH"],
            parameters: ["nivelInstruccion"],
        },
        "nivelInstruccion.destroy": {
            uri: "secundaria/nivelInstruccion/{nivelInstruccion}",
            methods: ["DELETE"],
            parameters: ["nivelInstruccion"],
        },
        ...
        "ley_social.store": { uri: "secundaria/ley_social", methods: ["POST"] },
        "ley_social.show": {
            uri: "secundaria/ley_social/{ley_social}",
            methods: ["GET", "HEAD"],
            parameters: ["ley_social"],
        },
        "ley_social.edit": {
        ...
        "planta.index": { uri: "secundaria/planta", methods: ["GET", "HEAD"] },
        "planta.create": {
            uri: "secundaria/planta/create",
            methods: ["GET", "HEAD"],
        },
        "planta.store": { uri: "secundaria/planta", methods: ["POST"] },
        "planta.show": {
        ...
        "prevision.store": { uri: "secundaria/prevision", methods: ["POST"] },
        "prevision.show": {
        ...
        "pueblo.index": { uri: "secundaria/pueblo", methods: ["GET", "HEAD"] },
        "pueblo.create": {
            uri: "secundaria/pueblo/create",
            methods: ["GET", "HEAD"],
        },
        "pueblo.store": { uri: "secundaria/pueblo", methods: ["POST"] },
        "pueblo.show": {
        ...
        "religion.store": { uri: "secundaria/religion", methods: ["POST"] },
        "religion.show": {
        ...
        "semaforo.store": { uri: "secundaria/semaforo", methods: ["POST"] },
        "semaforo.show": {
        ...
        "seguro.index": { uri: "secundaria/seguro", methods: ["GET", "HEAD"] },
        "seguro.create": {
            uri: "secundaria/seguro/create",
            methods: ["GET", "HEAD"],
        },
        "seguro.store": { uri: "secundaria/seguro", methods: ["POST"] },
        "seguro.show": {
        ...
        "turno.index": { uri: "secundaria/turno", methods: ["GET", "HEAD"] },
        "turno.create": {
            uri: "secundaria/turno/create",
            methods: ["GET", "HEAD"],
        },
        "turno.store": { uri: "secundaria/turno", methods: ["POST"] },
        "turno.show": {
        ...
        "unidad.index": { uri: "secundaria/unidad", methods: ["GET", "HEAD"] },
        "unidad.create": {
            uri: "secundaria/unidad/create",
            methods: ["GET", "HEAD"],
        },
        "unidad.store": { uri: "secundaria/unidad", methods: ["POST"] },
        "unidad.show": {
        ...
        dashboard: { uri: "dashboard/dashboard", methods: ["GET", "HEAD"] },
        personasPorEmpresa: {
        ...
        expo_planta: { uri: "dashboard/expo_planta", methods: ["GET", "HEAD"] },
        enfermedad_empresa: {
        ...
        "paciente.dashboard": {
            uri: "paciente/dashboard",
            methods: ["GET", "HEAD"],
        },
        "admin.dashboard": { uri: "admin/dashboard", methods: ["GET", "HEAD"] },
        "staff.dashboard": { uri: "staff/dashboard", methods: ["GET", "HEAD"] },
        "alergia.index": { uri: "alergia", methods: ["GET", "HEAD"] },
        "alergia.create": { uri: "alergia/create", methods: ["GET", "HEAD"] },
        "alergia.store": { uri: "alergia", methods: ["POST"] },
        "alergia.show": {
        ...
        "atencion_diaria.store": { uri: "atencion_diaria", methods: ["POST"] },
        "atencion_diaria.show": {
            uri: "atencion_diaria/{atencion_diarium}",
            methods: ["GET", "HEAD"],
            parameters: ["atencion_diarium"],
        },
        ...
        "certificacion.store": { uri: "certificacion", methods: ["POST"] },
        "certificacion.show": {
            uri: "certificacion/{certificacion}",
            methods: ["GET", "HEAD"],
            parameters: ["certificacion"],
        },
        "certificacion.edit": {
        ...
        "cirugia.index": { uri: "cirugia", methods: ["GET", "HEAD"] },
        "cirugia.create": { uri: "cirugia/create", methods: ["GET", "HEAD"] },
        "cirugia.store": { uri: "cirugia", methods: ["POST"] },
        "cirugia.show": {
        ...
        "diat.index": { uri: "diat", methods: ["GET", "HEAD"] },
        "diat.create": { uri: "diat/create", methods: ["GET", "HEAD"] },
        "diat.store": { uri: "diat", methods: ["POST"] },
        "diat.show": {
            uri: "diat/{diat}",
            methods: ["GET", "HEAD"],
            parameters: ["diat"],
        ...
        "diep.index": { uri: "diep", methods: ["GET", "HEAD"] },
        "diep.create": { uri: "diep/create", methods: ["GET", "HEAD"] },
        "diep.store": { uri: "diep", methods: ["POST"] },
        "diep.show": {
            uri: "diep/{diep}",
            methods: ["GET", "HEAD"],
            parameters: ["diep"],
        ...
        "enfermedad.index": { uri: "enfermedad", methods: ["GET", "HEAD"] },
        "enfermedad.create": {
            uri: "enfermedad/create",
            methods: ["GET", "HEAD"],
        },
        "enfermedad.store": { uri: "enfermedad", methods: ["POST"] },
        "enfermedad.show": {
            uri: "enfermedad/{enfermedad}",
            methods: ["GET", "HEAD"],
            parameters: ["enfermedad"],
        },
        "enfermedad.edit": {
        ...
        "factor.index": { uri: "factor", methods: ["GET", "HEAD"] },
        "factor.create": { uri: "factor/create", methods: ["GET", "HEAD"] },
        "factor.store": { uri: "factor", methods: ["POST"] },
        "factor.show": {
            uri: "factor/{factor}",
            methods: ["GET", "HEAD"],
            parameters: ["factor"],
        ...
        "familiar.index": { uri: "familiar", methods: ["GET", "HEAD"] },
        "familiar.create": { uri: "familiar/create", methods: ["GET", "HEAD"] },
        "familiar.store": { uri: "familiar", methods: ["POST"] },
        "familiar.show": {
        ...
        "licencia.index": { uri: "licencia", methods: ["GET", "HEAD"] },
        "licencia.create": { uri: "licencia/create", methods: ["GET", "HEAD"] },
        "licencia.store": { uri: "licencia", methods: ["POST"] },
        "licencia.show": {
            uri: "licencia/{licencium}",
            methods: ["GET", "HEAD"],
            parameters: ["licencium"],
        },
        "licencia.edit": {
        ...
        "medicamento.index": { uri: "medicamento", methods: ["GET", "HEAD"] },
        "medicamento.create": {
            uri: "medicamento/create",
            methods: ["GET", "HEAD"],
        },
        "medicamento.store": { uri: "medicamento", methods: ["POST"] },
        "medicamento.show": {
            uri: "medicamento/{medicamento}",
            methods: ["GET", "HEAD"],
            parameters: ["medicamento"],
        },
        "medicamento.edit": {
        ...
        "paciente.index": { uri: "paciente", methods: ["GET", "HEAD"] },
        "paciente.create": { uri: "paciente/create", methods: ["GET", "HEAD"] },
        "paciente.store": { uri: "paciente", methods: ["POST"] },
        "paciente.show": {
        ...
        "vacuna.index": { uri: "vacuna", methods: ["GET", "HEAD"] },
        "vacuna.create": { uri: "vacuna/create", methods: ["GET", "HEAD"] },
        "vacuna.store": { uri: "vacuna", methods: ["POST"] },
        "vacuna.show": {
            uri: "vacuna/{vacuna}",
            methods: ["GET", "HEAD"],
            parameters: ["vacuna"],
        ...
        "pacientes.enviar-activacion": {
            uri: "pacientes/{paciente}/enviar-activacion",
            methods: ["POST"],
            parameters: ["paciente"],
            bindings: { paciente: "id" },
        },
        "pacientes.reenviar-activacion": {
            uri: "pacientes/{paciente}/reenviar-activacion",
            methods: ["POST"],
            parameters: ["paciente"],
            bindings: { paciente: "id" },
        },
        "paciente.mi_dashboard": {
            uri: "paciente/mi_dashboard",
            methods: ["GET", "HEAD"],
        },
        "paciente.perfil": { uri: "paciente/perfil", methods: ["GET", "HEAD"] },
        "paciente.perfil.update": { uri: "paciente/perfil", methods: ["PUT"] },
        "paciente.activar.formulario": {
            uri: "paciente/activar/{token}",
            methods: ["GET", "HEAD"],
            parameters: ["token"],
        },
        "paciente.activar": {
            uri: "activar-cuenta/{token}",
            methods: ["GET", "HEAD"],
            parameters: ["token"],
        },
        "paciente.completar-activacion": {
            uri: "activar-cuenta/{token}",
            methods: ["POST"],
            parameters: ["token"],
        },
