                                                  ...
                                                  default: withCtx((_8, _push9, _parent9, _scopeId8) => {
                                                    if (_push9) {
                                                      _push9(ssrRenderComponent(_component_v_select, {
                                                        ...
                                                        modelValue: state.searchQuery.nivel_riesgo,
                                                        "onUpdate:modelValue": ($event) => state.searchQuery.nivel_riesgo = $event,
                                                        variant: "underlined",
                                                      ...
                                                      _push9(ssrRenderComponent(_component_v_text_field, {
                                                        ...
                                                        variant: "underlined",
                                                        modelValue: state.searchQuery.fecha_primer.desde,
                                                        "onUpdate:modelValue": ($event) => state.searchQuery.fecha_primer.desde = $event,
                                                        type: "date"
                                                      }, null, _parent9, _scopeId8));
                                                      _push9(ssrRenderComponent(_component_v_text_field, {
                                                        ...
                                                        variant: "underlined",
                                                        type: "date",
                                                        modelValue: state.searchQuery.fecha_primer.hasta,
                                                        "onUpdate:modelValue": ($event) => state.searchQuery.fecha_primer.hasta = $event
                                                      }, null, _parent9, _scopeId8));
                                                      _push9(ssrRenderComponent(_component_v_text_field, {
                                                        label: "Fecha segundo exámen (desde)",
                                                        variant: "underlined",
                                                        modelValue: state.searchQuery.fecha_segundo.desde,
                                                        "onUpdate:modelValue": ($event) => state.searchQuery.fecha_segundo.desde = $event,
                                                        type: "date"
                                                      }, null, _parent9, _scopeId8));
                                                      _push9(ssrRenderComponent(_component_v_text_field, {
                                                        ...
                                                        variant: "underlined",
                                                        type: "date",
                                                        modelValue: state.searchQuery.fecha_segundo.hasta,
                                                        "onUpdate:modelValue": ($event) => state.searchQuery.fecha_segundo.hasta = $event
                                                      }, null, _parent9, _scopeId8));
                                                    } else {
                                                      return [
                                                        createVNode(_component_v_select, {
                                            ...
                                            default: withCtx((_7, _push8, _parent8, _scopeId7) => {
                                              if (_push8) {
                                                _push8(ssrRenderComponent(_component_v_card_title, null, {
                                                  default: withCtx((_8, _push9, _parent9, _scopeId8) => {
                                                    if (_push9) {
                                                      _push9(`<span class="text-h5"${_scopeId8}> Consulta exámenes SOMNOLENCIA </span>`);
                                                    } else {
                                                      return [
                                                        createVNode("span", { class: "text-h5" }, " Consulta exámenes SOMNOLENCIA ")
                                                      ];
                                                    }
                                                  }),
                                                  _: 1
                                                        ...
                                                        default: withCtx((_9, _push10, _parent10, _scopeId9) => {
                                                          if (_push10) {
                                                            _push10(ssrRenderComponent(_component_v_text_field, {
                                                              modelValue: state.itemsView.nivel_riesgo,
                                                              "onUpdate:modelValue": ($event) => state.itemsView.nivel_riesgo = $event,
                                                              label: "Nivel de Riesgo",
                                                              type: "text",
                                                              variant: "underlined"
                                                      ...
                                                      _push9(ssrRenderComponent(_component_v_col, null, {
                                                        default: withCtx((_9, _push10, _parent10, _scopeId9) => {
                                                          if (_push10) {
                                                            ...
                                                            _push10(ssrRenderComponent(_component_v_text_field, {
                                                              modelValue: state.itemsView.fecha_primer,
                                                              "onUpdate:modelValue": ($event) => state.itemsView.fecha_primer = $event,
                                                              label: "Fecha primer",
                                                              type: "date",
                                                              variant: "underlined"
                                                            }, null, _parent10, _scopeId9));
                                                            _push10(ssrRenderComponent(_component_v_text_field, {
                                                              modelValue: state.itemsView.fecha_segundo,
                                                              "onUpdate:modelValue": ($event) => state.itemsView.fecha_segundo = $event,
                                                              label: "Fecha segundo",
                                                              type: "date",
                                                              variant: "underlined"
                                                            }, null, _parent10, _scopeId9));
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Consultas/ConsultaExSomnolencia.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const ConsultaExSomnolencia = /* @__PURE__ */ _export_sfc(_sfc_main, [["__file", "/home/omar/www/esalud/resources/js/Pages/Consultas/ConsultaExSomnolencia.vue"]]);
export {
  ConsultaExSomnolencia as default
};
//# sourceMappingURL=ConsultaExSomnolencia-nJy3uWfL.js.map
