...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const state = reactive({
      ...
      valid: null,
      formTitle: "Sílice",
      formCrear: "Nuevo exámen de Sílice",
      formEdit: "Editar exámen de Sílice",
      urlShow: "/examen/silice/show",
      urlUpdate: "/examen/silice/update",
      urlDelete: "/examen/silice/delete",
      urlStore: "/examen/silice"
    });
    onMounted(async () => {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Examenes/ExamenSilice.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const ExSilice = /* @__PURE__ */ _export_sfc(_sfc_main, [["__file", "/home/omar/www/esalud/resources/js/Pages/Examenes/ExamenSilice.vue"]]);
export {
  ExSilice as default
};
//# sourceMappingURL=ExamenSilice-C32kko-g.js.map
