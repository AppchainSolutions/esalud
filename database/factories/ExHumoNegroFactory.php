...
class ExHumoNegroFactory extends Factory
{
    ...
    private function generarComentario(\DateTime $fechaIngreso, \DateTime $fechaControl): ?string
    {
        $tiposComentarios = [
            ...
            'Evaluación de exposición a humo negro',
            'Monitoreo de riesgos ocupacionales',
            'Control de condiciones ambientales',
            
            // Observaciones
            'Sin hallazgos significativos',
            'Leve exposición detectada',
    ...
    public function pendiente()
    {
        return $this->state(function (array $attributes) {
            return [
                ...
                'comentario' => 'Examen de exposición a humo negro pendiente de realización'
            ];
        });
    }
    ...
    public function completado()
    {
        return $this->state(function (array $attributes) {
            return [
                ...
                'comentario' => 'Examen de exposición a humo negro completado satisfactoriamente'
            ];
        });
    }
    ...
    public function exposicionDetectada()
    {
        return $this->state(function (array $attributes) {
            return [
                ...
                'comentario' => 'Exposición a humo negro detectada. Requiere monitoreo y medidas preventivas.'
            ];
        });
    }
    ...
    public function altoRiesgo()
    {
        return $this->state(function (array $attributes) {
            return [
                'estado_examen' => 'En Seguimiento',
                'comentario' => 'Alto riesgo de exposición a humo negro. Requiere intervención inmediata y plan de mitigación.'
            ];
        });
    }
