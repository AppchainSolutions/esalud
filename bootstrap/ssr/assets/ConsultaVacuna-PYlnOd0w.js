                                                  ...
                                                  default: withCtx((_8, _push9, _parent9, _scopeId8) => {
                                                    if (_push9) {
                                                      _push9(ssrRenderComponent(_component_v_text_field, {
                                                        ...
                                                        variant: "underlined",
                                                        type: "text",
                                                        modelValue: state.searchQuery.vacuna,
                                                        "onUpdate:modelValue": ($event) => state.searchQuery.vacuna = $event
                                                      }, null, _parent9, _scopeId8));
                                            ...
                                            default: withCtx((_7, _push8, _parent8, _scopeId7) => {
                                              if (_push8) {
                                                _push8(ssrRenderComponent(_component_v_card_title, null, {
                                                  default: withCtx((_8, _push9, _parent9, _scopeId8) => {
                                                    if (_push9) {
                                                      _push9(`<span class="text-h5"${_scopeId8}> Consulta de Vacunas </span>`);
                                                    } else {
                                                      return [
                                                        createVNode("span", { class: "text-h5" }, " Consulta de Vacunas ")
                                                      ];
                                                    }
                                                  }),
                                                  _: 1
                                                    ...
                                                    if (_push9) {
                                                        ...
                                                        default: withCtx((_9, _push10, _parent10, _scopeId9) => {
                                                          if (_push10) {
                                                            _push10(ssrRenderComponent(_component_v_text_field, {
                                                              modelValue: state.itemsView.fecha_vacuna,
                                                              "onUpdate:modelValue": ($event) => state.itemsView.fecha_vacuna = $event,
                                                              label: "Fecha Vacuna",
                                                              type: "date",
                                                              variant: "underlined",
                                                              readonly: ""
                                                            ...
                                                            _push10(ssrRenderComponent(_component_v_text_field, {
                                                              modelValue: state.itemsView.tipo_vacuna,
                                                              "onUpdate:modelValue": ($event) => state.itemsView.tipo_vacuna = $event,
                                                              type: "text",
                                                      ...
                                                      _push9(ssrRenderComponent(_component_v_col, null, {
                                                        default: withCtx((_9, _push10, _parent10, _scopeId9) => {
                                                          if (_push10) {
                                                            _push10(ssrRenderComponent(_component_v_text_field, {
                                                              modelValue: state.itemsView.vacuna,
                                                              "onUpdate:modelValue": ($event) => state.itemsView.vacuna = $event,
                                                              readonly: "",
                                                              type: "text",
                                                              label: "Vacuna",
                                                              variant: "underlined"
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Consultas/ConsultaVacuna.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const ConsultaVacuna = /* @__PURE__ */ _export_sfc(_sfc_main, [["__file", "/home/omar/www/esalud/resources/js/Pages/Consultas/ConsultaVacuna.vue"]]);
export {
  ConsultaVacuna as default
};
//# sourceMappingURL=ConsultaVacuna-PYlnOd0w.js.map
