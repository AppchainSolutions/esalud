...
import { A as ActionMessage } from "./ActionMessage-BcEvr_vd.js";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const logoutOtherBrowserSessions = () => {
      form.delete(route("other-browser-sessions.delete"), {
        preserveScroll: true,
      ...
      _push(ssrRenderComponent(ActionSection, _attrs, {
        ...
        content: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(PrimaryButton, { onClick: confirmLogout }, {
            ...
            _push2(`</div>`);
            _push2(ssrRenderComponent(DialogModal, {
              ...
              footer: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(SecondaryButton, { onClick: closeModal }, {
            ...
            return [
              ...
              createVNode("div", { class: "flex items-center mt-5" }, [
                createVNode(PrimaryButton, { onClick: confirmLogout }, {
                  default: withCtx(() => [
                    createTextVNode(" Log Out Other Browser Sessions ")
                  ]),
                  _: 1
...
const LogoutOtherBrowserSessionsForm = /* @__PURE__ */ _export_sfc(_sfc_main, [["__file", "/home/blueshadows/www/app-empresas/resources/js/Pages/Profile/Partials/LogoutOtherBrowserSessionsForm.vue"]]);
export {
  LogoutOtherBrowserSessionsForm as default
};
//# sourceMappingURL=LogoutOtherBrowserSessionsForm-DOwt4UHm.js.map
