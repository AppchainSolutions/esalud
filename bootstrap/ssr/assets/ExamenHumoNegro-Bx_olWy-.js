...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const state = reactive({
      ...
      loading: false,
      valid: null,
      formTitle: "Humos Negros",
      formCrear: "Nuevo exámen de Humos Negros",
      formEdit: "Editar exámen de Humos Negros",
      urlShow: "/examen/humonegro/show",
      urlUpdate: "/examen/humonegro/update",
      urlDelete: "/examen/humonegro/delete",
      urlStore: "/examen/humonegro"
    });
    onMounted(async () => {
                                                              ...
                                                              default: withCtx((_10, _push11, _parent11, _scopeId10) => {
                                                                if (_push11) {
                                                                  ...
                                                                  _push11(ssrRenderComponent(_component_v_select, {
                                                                    items: state.list.estado_examen,
                                                                    modelValue: state.editedItem.estado_examen,
                                                                    "onUpdate:modelValue": ($event) => state.editedItem.estado_examen = $event,
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Examenes/ExamenHumoNegro.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const ExHumoNegro = /* @__PURE__ */ _export_sfc(_sfc_main, [["__file", "/home/omar/www/esalud/resources/js/Pages/Examenes/ExamenHumoNegro.vue"]]);
export {
  ExHumoNegro as default
};
//# sourceMappingURL=ExamenHumoNegro-Bx_olWy-.js.map
