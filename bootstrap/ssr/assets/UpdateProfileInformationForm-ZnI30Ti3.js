...
import { I as InputError, T as TextInput } from "./TextInput-AKTH8tze.js";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(FormSection, mergeProps({ onSubmitted: updateProfileInformation }, _attrs), {
          ...
          if (_push2) {
            ...
            return [
              _ctx.$page.props.jetstream.managesProfilePhotos ? (openBlock(), createBlock("div", {
                ...
                __props.user.profile_photo_path ? (openBlock(), createBlock(SecondaryButton, {
                  key: 0,
                  type: "button",
                  class: "mt-2",
...
const UpdateProfileInformationForm = /* @__PURE__ */ _export_sfc(_sfc_main, [["__file", "/home/blueshadows/www/app-empresas/resources/js/Pages/Profile/Partials/UpdateProfileInformationForm.vue"]]);
export {
  UpdateProfileInformationForm as default
};
//# sourceMappingURL=UpdateProfileInformationForm-ZnI30Ti3.js.map
