...
const handleSearch = async () => {
    await handsearchItemsems(state);
};
</script>
                            ...
                            <v-row>
                                ...
                                <v-col>
                                    <v-text-field
                                        ...
                                        variant="underlined"
                                        v-model="
                                            state.searchQuery.fecha_examen.desde
                                        "
                                        type="date"
                                        clearable
                                    ></v-text-field>
                                    <v-text-field
                                        ...
                                        clearable
                                        v-model="
                                            state.searchQuery.fecha_examen.hasta
                                        "
                                    ></v-text-field>
                                    <v-text-field
                                        ...
                                        clearable
                                        v-model="
                                            state.searchQuery.fecha_control
                                                .desde
                                        "
                                        type="date"
                                    ></v-text-field>
                            ...
                            <v-card-text>
                                ...
                                <v-row>
                                    <v-col>
                                        ...
                                        <v-text-field
                                            v-model="state.itemsView.nordico"
                                            label="Nordico"
                                            type="text"
                                            variant="underlined"
                                        ></v-text-field>
                                    ...
                                    <v-col>
                                        <v-text-field
                                            v-model="state.itemsView.quickdash"
                                            label="Quickdash"
                                            type="text"
                                            variant="underlined"
                                        ></v-text-field>
