const Ziggy = {
    ...
    routes: {
        ...
        "AfpModel;.index": {
            uri: "secundaria/AfpModel;",
            methods: ["GET", "HEAD"],
        },
        "AfpModel;.create": {
            uri: "secundaria/AfpModel;/create",
            methods: ["GET", "HEAD"],
        },
        "AfpModel;.store": { uri: "secundaria/AfpModel;", methods: ["POST"] },
        "AfpModel;.show": {
            uri: "secundaria/AfpModel;/{AfpModel;}",
            methods: ["GET", "HEAD"],
            parameters: ["AfpModel;"],
        },
        "AfpModel;.edit": {
            uri: "secundaria/AfpModel;/{AfpModel;}/edit",
            methods: ["GET", "HEAD"],
            parameters: ["AfpModel;"],
        },
        "AfpModel;.update": {
        ...
        "AlergiaModel.index": { uri: "AlergiaModel", methods: ["GET", "HEAD"] },
        "AlergiaModel.create": {
            uri: "AlergiaModel/create",
            methods: ["GET", "HEAD"],
        },
        "AlergiaModel.store": { uri: "AlergiaModel", methods: ["POST"] },
        "AlergiaModel.show": {
            uri: "AlergiaModel/{alergium}",
            methods: ["GET", "HEAD"],
            parameters: ["alergium"],
        },
        "AlergiaModel.edit": {
            uri: "AlergiaModel/{alergium}/edit",
            methods: ["GET", "HEAD"],
            parameters: ["alergium"],
        },
        "AlergiaModel.update": {
