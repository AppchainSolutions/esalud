...
const state = reactive({
  ...
  loadingSearch: false,
  tableItems: [],
  urlDelete: "/profesional/destroy",
  urlShow: "/profesional/show",
  urlAll: "/profesional/",
  urlStore: "/profesional/store",
  urlUpdate: "/profesional/update",
});
const date = useDate();
        ...
        <v-row>
          <v-col>
            ...
            <v-select :items="[
              ...
              'Kine',
              'Terapia Ocupacional',
            ]" clearable label="Especialidad" class="ma-2" variant="underlined" single></v-select>
          </v-col>
        </v-row>
