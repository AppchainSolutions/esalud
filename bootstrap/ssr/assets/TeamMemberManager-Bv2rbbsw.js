...
import { C as ConfirmationModal } from "./ConfirmationModal-CvHOqZUG.js";
import { D as DangerButton } from "./DangerButton-1WlxjJMA.js";
import { D as DialogModal } from "./DialogModal-CWfZrpOs.js";
import { F as FormSection } from "./FormSection-nV8niOwm.js";
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (__props.userPermissions.canAddTeamMembers) {
        ...
        _push(ssrRenderComponent(FormSection, { onSubmitted: addTeamMember }, {
      ...
      if (__props.team.team_invitations.length > 0 && __props.userPermissions.canAddTeamMembers) {
        _push(`<div>`);
        _push(ssrRenderComponent(SectionBorder, null, null, _parent));
        _push(ssrRenderComponent(ActionSection, { class: "mt-10 sm:mt-0" }, {
          title: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
...
const TeamMemberManager = /* @__PURE__ */ _export_sfc(_sfc_main, [["__file", "/home/blueshadows/www/app-empresas/resources/js/Pages/Teams/Partials/TeamMemberManager.vue"]]);
export {
  TeamMemberManager as default
};
//# sourceMappingURL=TeamMemberManager-Bv2rbbsw.js.map
