...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('paciente', function (Blueprint $table) {
            ...
            $table->boolean('comunidad_lgtbq_responsable')->default(false);
            ...
            $table->foreignId('Calles_id')->nullable()->constrained()->onDelete('cascade');
            $table->foreignId('Calles_responsable_id')->nullable()->constrained('Calless')->onDelete('cascade');
            $table->foreignId('establecimiento_educacional_id')->nullable()->constrained('establecimientos_educacionales')->onDelete('cascade');
            $table->foreignId('estado_civil_id')->nullable()->constrained()->onDelete('cascade');
            $table->foreignId('estado_civil_responsable_id')->nullable()->constrained('estados_civiles')->onDelete('cascade');
            $table->foreignId('genero_id')->nullable()->constrained()->onDelete('cascade');
            $table->foreignId('genero_responsable_id')->nullable()->constrained('generos')->onDelete('cascade');
            $table->foreignId('grupo_sanguineo_id')->nullable()->constrained()->onDelete('cascade');
            $table->foreignId('grupo_sanguineo_responsable_id')->nullable()->constrained('grupos_sanguineos')->onDelete('cascade');
            $table->foreignId('nacionalidad_id')->nullable()->constrained()->onDelete('cascade');
            $table->foreignId('nacionalidad_responsable_id')->nullable()->constrained('nacionalidades')->onDelete('cascade');
            $table->foreignId('nivel_instruccion_id')->nullable()->constrained()->onDelete('cascade');
            $table->foreignId('nivel_instruccion_responsable_id')->nullable()->constrained('niveles_instruccion')->onDelete('cascade');
            $table->foreignId('prevision_id')->nullable()->constrained()->onDelete('cascade');
            $table->foreignId('prevision_responsable_id')->nullable()->constrained('previsiones')->onDelete('cascade');
            $table->foreignId('pueblo_originario_id')->nullable()->constrained()->onDelete('cascade');
