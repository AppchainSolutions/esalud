import { reactive, computed, resolveComponent, unref, withCtx, createTextVNode, createVNode, mergeProps, toDisplayString, withModifiers, useSSRContext } from "vue";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--[-->${ssrInterpolate(unref(paciente))} `);
                                                        ...
                                                        default: withCtx((_9, _push10, _parent10, _scopeId9) => {
                                                          if (_push10) {
                                                            _push10(ssrRenderComponent(_component_v_text_field, {
                                                              modelValue: state.editedItem.alergia,
                                                              "onUpdate:modelValue": ($event) => state.editedItem.alergia = $event,
                                                              label: "alergia",
                                                              type: "text",
                                                              variant: "underlined"
                                                            }, null, _parent10, _scopeId9));
                                                            _push10(ssrRenderComponent(_component_v_text_field, {
                                                              modelValue: state.editedItem.fecha_alergia,
                                                              "onUpdate:modelValue": ($event) => state.editedItem.fecha_alergia = $event,
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/SubPages/Alergia.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const Alergia = /* @__PURE__ */ _export_sfc(_sfc_main, [["__file", "/home/omar/www/esalud/resources/js/Pages/SubPages/Alergia.vue"]]);
export {
  Alergia as default
};
//# sourceMappingURL=Alergia-Zu3tShu8.js.map
