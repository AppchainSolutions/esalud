...
const _sfc_main = /* @__PURE__ */ Object.assign({ layout: AppLayout }, {
  __name: "ConsultaExHumoNegro",
  __ssrInlineRender: true,
  setup(__props) {
    const state = reactive({
      endpoints: ["estado_epo", "area", "ceco", "empresa", "planta", "unidad"],
      headers: [
        {
          title: "Rut",
          align: "start",
      ...
      list: [],
      valid: null,
      formTitle: "Consulta exámen Humos Negros",
      urlSearch: "/consulta/exhumonegro/search"
    });
    onMounted(async () => {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Consultas/ConsultaExHumoNegro.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const ConsultaExHumoNegro = /* @__PURE__ */ _export_sfc(_sfc_main, [["__file", "/home/omar/www/esalud/resources/js/Pages/Consultas/ConsultaExHumoNegro.vue"]]);
export {
  ConsultaExHumoNegro as default
};
//# sourceMappingURL=ConsultaExHumoNegro-BPSRJgDk.js.map
