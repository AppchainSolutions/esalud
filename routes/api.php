...
Route::get('modalidad/all', [ModalidadController::class, 'all'])->name('modalidad.all');
Route::get('nacionalidad/all', [NacionalidadController::class, 'all'])->name('modalidad.all');
Route::get('nivel_instruccion/all', [NivelInstruccionController::class, 'all'])->name('grupoSanguineo.all');
