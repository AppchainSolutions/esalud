                                            ...
                                            default: withCtx((_7, _push8, _parent8, _scopeId7) => {
                                              if (_push8) {
                                                _push8(ssrRenderComponent(_component_v_card_title, null, {
                                                  default: withCtx((_8, _push9, _parent9, _scopeId8) => {
                                                    if (_push9) {
                                                      _push9(`<span class="text-h5"${_scopeId8}> Consulta exámenes ALCOHOL Y DROGAS </span>`);
                                                    } else {
                                                      return [
                                                        createVNode("span", { class: "text-h5" }, " Consulta exámenes ALCOHOL Y DROGAS ")
                                                      ];
                                                    }
                                                  }),
                                                  _: 1
                                                    ...
                                                    if (_push9) {
                                                      _push9(ssrRenderComponent(_component_v_col, null, {
                                                        default: withCtx((_9, _push10, _parent10, _scopeId9) => {
                                                          if (_push10) {
                                                            ...
                                                            _push10(ssrRenderComponent(_component_v_text_field, {
                                                              modelValue: state.itemsView.sustancia,
                                                              "onUpdate:modelValue": ($event) => state.itemsView.sustancia = $event,
                                                              label: "Sustancia",
                                                              type: "text",
                                                              variant: "underlined"
                                                            }, null, _parent10, _scopeId9));
                                                      ...
                                                      _push9(ssrRenderComponent(_component_v_col, null, {
                                                        default: withCtx((_9, _push10, _parent10, _scopeId9) => {
                                                          if (_push10) {
                                                            _push10(ssrRenderComponent(_component_v_text_field, {
                                                              modelValue: state.itemsView.item,
                                                              "onUpdate:modelValue": ($event) => state.itemsView.item = $event,
                                                              label: "Item",
                                                              type: "text",
                                                              variant: "underlined"
                                                            }, null, _parent10, _scopeId9));
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Consultas/ConsultaExAlcohol.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const ConsultaExAlcohol = /* @__PURE__ */ _export_sfc(_sfc_main, [["__file", "/home/omar/www/esalud/resources/js/Pages/Consultas/ConsultaExAlcohol.vue"]]);
export {
  ConsultaExAlcohol as default
};
//# sourceMappingURL=ConsultaExAlcohol-CVJ7mxNk.js.map
