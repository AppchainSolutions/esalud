...
const state = reactive({
    ...
    loading: false,
    tab: null,
    formTitle: "Ficha Paciente",
    formCrear: "Nueva Ficha",
    formEdit: "Editar Ficha",
    ...
    <v-container>
        <v-data-table :headers="state.headers" :items="state.tableItems">
                ...
                <v-dialog v-model="state.dialog">
                    <v-card class="ma-4 pa-4">
                        <form @submit.prevent="submit">
                            ...
                            <v-tabs v-model="state.tab" bg-color="#009AA4">
            ...
            <template v-slot:item.actions="{ item }">
                <v-tooltip text="Ver/Editar Ficha de Paciente" location="top">
