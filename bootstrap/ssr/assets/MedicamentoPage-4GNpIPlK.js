import { reactive, computed, resolveComponent, withCtx, createTextVNode, createVNode, toDisplayString, withModifiers, mergeProps, useSSRContext } from "vue";
                                                        ...
                                                        default: withCtx((_9, _push10, _parent10, _scopeId9) => {
                                                          if (_push10) {
                                                            _push10(ssrRenderComponent(_component_v_text_field, {
                                                              modelValue: state.editedItem.medicamento,
                                                              "onUpdate:modelValue": ($event) => state.editedItem.medicamento = $event,
                                                              label: "Medicamento",
                                                              type: "text",
                                                              variant: "underlined"
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/SubPages/MedicamentoPage.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const Medicamento = /* @__PURE__ */ _export_sfc(_sfc_main, [["__file", "/home/blueshadows/www/esalud/resources/js/Pages/SubPages/MedicamentoPage.vue"]]);
export {
  Medicamento as default
};
//# sourceMappingURL=MedicamentoPage-4GNpIPlK.js.map
