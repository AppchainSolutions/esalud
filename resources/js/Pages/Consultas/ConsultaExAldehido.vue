                            ...
                            <v-row>
                                ...
                                <v-col>
                                    ...
                                    <v-text-field
                                        ...
                                        variant="underlined"
                                        v-model="
                                            state.searchQuery.fecha_ingreso
                                                .desde
                                        "
                                        type="date"
                                    ></v-text-field>
                                    ...
                                    <v-text-field
                                        ...
                                        variant="underlined"
                                        v-model="
                                            state.searchQuery.fecha_prox_control
                                                .desde
                                        "
                                        type="date"
                                    ></v-text-field>
                                    ...
                                    <v-text-field
                                        ...
                                        variant="underlined"
                                        v-model="
                                            state.searchQuery.fecha_ult_control
                                                .desde
                                        "
                                        type="date"
                                    ></v-text-field>
