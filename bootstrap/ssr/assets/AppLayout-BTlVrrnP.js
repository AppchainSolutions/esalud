                    ...
                    _push4(ssrRenderComponent(_component_v_app_bar_title, null, {
                      default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                        if (_push5) {
                          ...
                          _push5(` Bienvenido/a ${ssrInterpolate($data.user.name)}`);
                        } else {
                          return [
                            ...
                            createTextVNode(" Bienvenido/a " + toDisplayString($data.user.name), 1)
                          ];
                        }
                      }),
                      _: 1
...
//# sourceMappingURL=AppLayout-BTlVrrnP.js.map
