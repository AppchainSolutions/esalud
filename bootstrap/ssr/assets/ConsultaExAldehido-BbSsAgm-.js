...
const _sfc_main = /* @__PURE__ */ Object.assign({ layout: AppLayout }, {
  ...
  setup(__props) {
    const state = reactive({
      ...
      editedIndex: -1,
      list: [],
      formTitle: "Consulta Exámen Aldehídos",
      urlSearch: "/consulta/exaldehido/search"
    });
    onMounted(async () => {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Consultas/ConsultaExAldehido.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const ConsultaExAldehido = /* @__PURE__ */ _export_sfc(_sfc_main, [["__file", "/home/omar/www/esalud/resources/js/Pages/Consultas/ConsultaExAldehido.vue"]]);
export {
  ConsultaExAldehido as default
};
//# sourceMappingURL=ConsultaExAldehido-BbSsAgm-.js.map
