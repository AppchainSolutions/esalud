...
const _sfc_main = /* @__PURE__ */ Object.assign({ layout: AppLayout }, {
  ...
  setup(__props) {
    const state = reactive({
      ...
      list: [],
      valid: null,
      formTitle: "Consulta Exámen Ruido",
      urlSearch: "/consulta/exruido/search"
    });
    onMounted(async () => {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Consultas/ConsultaExRuido.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const ConsultaExRuido = /* @__PURE__ */ _export_sfc(_sfc_main, [["__file", "/home/omar/www/esalud/resources/js/Pages/Consultas/ConsultaExRuido.vue"]]);
export {
  ConsultaExRuido as default
};
//# sourceMappingURL=ConsultaExRuido-DXZLiVI2.js.map
