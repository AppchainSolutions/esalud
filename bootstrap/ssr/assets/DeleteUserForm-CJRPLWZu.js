...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const deleteUser = () => {
      form.delete(route("current-user.delete"), {
        preserveScroll: true,
      ...
      _push(ssrRenderComponent(ActionSection, _attrs, {
        ...
        content: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(DangerButton, { onClick: confirmUserDeletion }, {
            ...
            return [
              ...
              createVNode("div", { class: "mt-5" }, [
                createVNode(DangerButton, { onClick: confirmUserDeletion }, {
                  default: withCtx(() => [
                    createTextVNode(" Delete Account ")
                  ]),
                  _: 1
...
const DeleteUserForm = /* @__PURE__ */ _export_sfc(_sfc_main, [["__file", "/home/blueshadows/www/app-empresas/resources/js/Pages/Profile/Partials/DeleteUserForm.vue"]]);
export {
  DeleteUserForm as default
};
//# sourceMappingURL=DeleteUserForm-CJRPLWZu.js.map
