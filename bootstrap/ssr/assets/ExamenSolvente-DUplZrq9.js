...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const state = reactive({
      ...
      valid: null,
      formTitle: "Solvente",
      formCrear: "Nuevo exámen de Solvente",
      formEdit: "Editar exámen de Solvente",
      urlShow: "/examen/solvente/show",
      urlUpdate: "/examen/solventelice/update",
      urlDelete: "/examen/solvente/delete",
      urlStore: "/examen/solvente"
    });
    onMounted(async () => {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Examenes/ExamenSolvente.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const ExSolvente = /* @__PURE__ */ _export_sfc(_sfc_main, [["__file", "/home/omar/www/esalud/resources/js/Pages/Examenes/ExamenSolvente.vue"]]);
export {
  ExSolvente as default
};
//# sourceMappingURL=ExamenSolvente-DUplZrq9.js.map
