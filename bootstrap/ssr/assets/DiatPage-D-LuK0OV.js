                                                          ...
                                                          if (_push10) {
                                                              ...
                                                              default: withCtx((_10, _push11, _parent11, _scopeId10) => {
                                                                if (_push11) {
                                                                  _push11(ssrRenderComponent(_component_v_switch, {
                                                                    label: "Aprobado",
                                                                    modelValue: state.editedItem.aprobado,
                                                                    "onUpdate:modelValue": ($event) => state.editedItem.aprobado = $event,
                                                                    "hide-details": "",
                                                                    "true-value": "true",
                                                                    "false-value": "false",
                                                                    variant: "underlined",
                                                            ...
                                                            _push10(ssrRenderComponent(_component_v_col, null, {
                                                              default: withCtx((_10, _push11, _parent11, _scopeId10) => {
                                                                if (_push11) {
                                                                  _push11(ssrRenderComponent(_component_v_select, {
                                                                    modelValue: state.editedItem.tipo_accidente,
                                                                    "onUpdate:modelValue": ($event) => state.editedItem.tipo_accidente = $event,
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Paciente/Componentes/DiatPage.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const DiatPage = /* @__PURE__ */ _export_sfc(_sfc_main, [["__file", "/home/omar/www/esalud/resources/js/Pages/Paciente/Componentes/DiatPage.vue"]]);
export {
  DiatPage as default
};
//# sourceMappingURL=DiatPage-D-LuK0OV.js.map
