...
class GenerarNotificacionesExamenesCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'examenes:notificar 
    ...
    public function handle()
    {
        ...
        try {
            ...
            $notificaciones = $this->notificacionService->generarNotificacionesVencimiento($dryRun);

            // Mostrar resumen de notificaciones
            $this->mostrarResumenNotificaciones($notificaciones, $logDetalles);

            // Registrar en log si es necesario
            if ($logDetalles) {
                $this->registrarDetallesNotificaciones($notificaciones);
            }
