                            ...
                            <v-row>
                                ...
                                <v-col>
                                    ...
                                    <v-text-field
                                        ...
                                        variant="underlined"
                                        v-model="
                                            state.searchQuery.fecha_primer.desde
                                        "
                                        type="date"
                                    ></v-text-field>
                                    <v-text-field
                                        ...
                                        type="date"
                                        v-model="
                                            state.searchQuery.fecha_primer.hasta
                                        "
                                    ></v-text-field>
                                    <v-text-field
                                        ...
                                        variant="underlined"
                                        v-model="
                                            state.searchQuery.fecha_segundo
                                                .desde
                                        "
                                        type="date"
                                    ></v-text-field>
