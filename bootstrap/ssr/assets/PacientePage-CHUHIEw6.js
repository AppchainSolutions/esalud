                                                              ...
                                                              default: withCtx((_10, _push11, _parent11, _scopeId10) => {
                                                                if (_push11) {
                                                                  _push11(ssrRenderComponent(_component_v_col, null, {
                                                                    default: withCtx((_11, _push12, _parent12, _scopeId11) => {
                                                                      if (_push12) {
                                                                        _push12(ssrRenderComponent(_component_v_select, { label: "Establecimiento educacional" }, null, _parent12, _scopeId11));
                                                                      } else {
                                                                        return [
                                                                          createVNode(_component_v_select, { label: "Establecimiento educacional" })
                                                                        ];
                                                                      }
                                                                    }),
                                                                    _: 1
                                                              ...
                                                              default: withCtx((_10, _push11, _parent11, _scopeId10) => {
                                                                if (_push11) {
                                                                  ...
                                                                  _push11(ssrRenderComponent(_component_v_switch, {
                                                                    modelValue: state.editedItem.credencial_discapacidad_responsable_id,
                                                                    "onUpdate:modelValue": ($event) => state.editedItem.credencial_discapacidad_responsable_id = $event,
                                                                    class: "ml-2",
                                                                    label: "Credencial discapacidad",
                                                                    color: "success",
                                                                    "hide-details": "",
...
//# sourceMappingURL=PacientePage-CHUHIEw6.js.map
